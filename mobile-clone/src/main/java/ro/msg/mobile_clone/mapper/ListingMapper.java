...
public interface ListingMapper {
    ...
    Listing mapToListing(ListingDto listingDto, @Context UserService userService) throws EntityNotFoundException;
    ...
    @Named("userIdToUser")
    default User userIdToUser(Long userId, @Context UserService userService) throws EntityNotFoundException {
